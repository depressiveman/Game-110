...
void collision(int x1, int x2, int y1, int y2);
...
int main(int argc, char **argv)
{
	...
	while (!doexit)
	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if (square_x == square2_x && square_y == square2_y) {
				collision(square_x, square2_x, square_y, square2_y);
			}
